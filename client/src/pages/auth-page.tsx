...
export default function AuthPage() {
  ...
  const shouldRedirect = user || loginMutation.isSuccess || registerMutation.isSuccess;
        ...
        <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:max-w-md">
            <div className="text-center mb-8">
              ...
              <h2 className="mt-2 text-3xl font-extrabold text-gray-900">PawCare</h2>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-8">
            <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-lg max-w-md">
              <h2 className="text-2xl font-bold text-primary-600 mb-4">
                Join the PawCare Family
              </h2>
              <p className="text-gray-700 mb-4">
                Your journey in animal rescue and welfare starts here. Help us give animals the second chance they deserve.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center">
                  ...
                  <span>Adopt rescued animals</span>
                </li>
                <li className="flex items-center">
                  <svg className="h-5 w-5 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                  </svg>
                  <span>Report animals in need</span>
                </li>
                <li className="flex items-center">
                  <svg className="h-5 w-5 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                  </svg>
                  <span>Track rescue and treatment progress</span>
                </li>
              </ul>
            </div>
          </div>
